...
from fb.views import (
    ...
    edit_profile_view, like_view, send_gift_view, show_gift_view, 
)
...
urlpatterns = patterns(
    ...
    url(r'^profile/(?P<username>\w+)/send_gift$', send_gift_view, name='send_gift'),
    url(r'^profile/(?P<username>\w+)/show_gift$', show_gift_view, name='show_gift'),
    # url(r'^profile/(?P<username>\w+)/single_gift$', single_gift_view, name='single_gift'),
